...
public readonly ref partial struct H6
{
	...
	public H6 WithCustomAttribute(string key, string? value = null)
	{
		WriteKey(key);
		WriteValue(value);
		return this;
	...
	public H6 WithCustomAttributes(scoped ReadOnlySpan<(string, string?)> attributes)
	{
