...
public readonly ref partial struct Ins : IHtmlElement<Ins>,
	ICiteAttribute<Ins>,
	IDateTimeAttribute<Ins>,
	IGlobalAttributes<Ins>
{
	...
	TextWriter IHtmlElement<Ins>.Writer => writer;
	static Ins IHtmlElement<Ins>.Create(TextWriter writer) => new(writer);
	static bool IHtmlElement<Ins>.IsVoidElement => false;
	static string IHtmlElement<Ins>.Name => ElementName;
	static ReadOnlySpan<string> IHtmlElement<Ins>.SupportedAttributes => _supportedAttributes;
