...
public readonly ref partial struct Noframes
{
	...
	public Noframes WithContextmenu(string? value = null)
	{
		Contextmenu = value;
		return this;
	}
	...
	public Noframes WithCustomAttribute(string key, string? value = null)
	{
		WriteKey(key);
		WriteValue(value);
		return this;
	...
	public Noframes WithCustomAttributes(scoped ReadOnlySpan<(string, string?)> attributes)
	{
