...
public readonly ref partial struct Output : IHtmlElement<Output>,
	IForAttribute<Output>,
	IFormAttribute<Output>,
	INameAttribute<Output>,
	IGlobalAttributes<Output>
{
	...
	TextWriter IHtmlElement<Output>.Writer => writer;
	static Output IHtmlElement<Output>.Create(TextWriter writer) => new(writer);
	static bool IHtmlElement<Output>.IsVoidElement => false;
	static string IHtmlElement<Output>.Name => ElementName;
	static ReadOnlySpan<string> IHtmlElement<Output>.SupportedAttributes => _supportedAttributes;
