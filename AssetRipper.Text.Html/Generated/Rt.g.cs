...
public readonly ref partial struct Rt : IHtmlElement<Rt>,
	IGlobalAttributes<Rt>
{
	...
	TextWriter IHtmlElement<Rt>.Writer => writer;
	static Rt IHtmlElement<Rt>.Create(TextWriter writer) => new(writer);
	static bool IHtmlElement<Rt>.IsVoidElement => false;
	static string IHtmlElement<Rt>.Name => ElementName;
	static ReadOnlySpan<string> IHtmlElement<Rt>.SupportedAttributes => _supportedAttributes;
