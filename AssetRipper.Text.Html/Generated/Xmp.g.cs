...
public readonly ref partial struct Xmp
{
	...
	public Xmp WithContextmenu(string? value = null)
	{
		Contextmenu = value;
		return this;
	}
	...
	public Xmp WithCustomAttribute(string key, string? value = null)
	{
		WriteKey(key);
		WriteValue(value);
		return this;
	...
	public Xmp WithCustomAttributes(scoped ReadOnlySpan<(string, string?)> attributes)
	{
